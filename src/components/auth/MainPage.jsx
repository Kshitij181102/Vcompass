          ...
          {['all', 'academic', 'cultural', 'sports', 'placement', 'workshop'].map((category) => (
            <button
              ...
              className={`px-6 py-3 rounded-full font-medium transition-all duration-300 backdrop-blur-sm border ${
                activeTab === category
                  ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg transform scale-105 border-white/20'
                  : 'bg-white/80 text-amber-700 hover:bg-white/90 hover:text-amber-800 border-white/20'
              }`}
            >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                        ...
                        poster.status === 'ongoing' ? 'bg-orange-100 text-orange-700' :
              ...
              <div className="flex items-center space-x-3">
                ...
                {modalType === 'poster' && selectedItem.status && (
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                    ...
                    selectedItem.status === 'ongoing' ? 'bg-orange-100 text-orange-700' :
                    'bg-gray-100 text-gray-700'
                  }`}>
                    {selectedItem.status}
                  </span>
